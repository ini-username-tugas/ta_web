                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 mt-5 mx-auto my-auto">
                            <div class="text-center">
                                <h2 class="text-center">You dumbass</h2>
                                <h6 class="text-center mb-4">How can you even forgot about your own password?</h6>
                            </div>
                            <?= $this->session->flashdata('message'); ?>
                            <form class="user justify-items-center" method="post" action="<?= base_url('auth/forgotpassword'); ?>">
                            ...
                            <div class="text-center">
                                <a class="small" href="<?= base_url('auth/login'); ?>">Already remembered your password? Login!</a>
                            </div>
                        </div>
                    </div>
                </div>
