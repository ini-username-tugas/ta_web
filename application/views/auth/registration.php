                ...
                <div class="card-body p-0 bg-grey">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 mt-5 mx-auto my-auto">
                            ...
                            <form class="user justify-items-center" method="post" action="<?= base_url('auth/registration'); ?>">
                            ...
                            <hr>
                            <div class="text-center">
                                <a class="small" href="<?= base_url('auth/login'); ?>">Already have an account? Log in!</a>
                            </div>
                            <div class="text-center">
